...
Конечно, программы написанные на PERFACARDOR, не будут супер производительными и полезными как на других языках. Причем, прошу заметить, я не говорил что PERFACARDOR, **официально** является языком программирования. Будем называть его так для удобства. 
